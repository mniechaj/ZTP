...
public class AppClient {
    public static void main(String[] args) {
        if (args.length != 2) {
            System.out.println("Program should be executed for 2 parameters!");
        }
        else {
            ...
            try {
                List<String> entries = Files.readAllLines(Paths.get(filePath), Charset.defaultCharset());
     ...
     */
    private int findMostSimilarLine(List<String> entries, String testSentence, Levenshtein levenshtein) {
